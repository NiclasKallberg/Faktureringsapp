...
namespace WebApplication.Utilities
{
    public class ErrorHandler
    {
        ...
        public static void HandleError(ErrorTypes errorType, Exception ex)
        {
            ...
            try
            {
                MailAddress fromAddress = new MailAddress("bot542439@gmail.com", "Allservice Error Bot");
                MailAddress toAddress = new MailAddress("niclas.kallberg3@gmail.com");
                const string fromPassword = "uigf wlhy zchs lyuu";
